...
app.isotope = {
  init: function() {
    var $grid_isotope, $quicksearch, buttonFilter, buttonFilters, concatValues, debounce, qsRegex;
    buttonFilters = {};
    buttonFilter = void 0;
    qsRegex = void 0;
...
app.modal = {
  init: function() {
    $(".modal__close").click(function() {
      ...
      return $(".modal--docs .modal__front").removeClass("modal__front--openinfo");
    });
...
app.scroll = {
  init: function() {
    ...
    $(window).scroll(function() {
      ...
      return app.scroll.parallax(scroll);
    });
